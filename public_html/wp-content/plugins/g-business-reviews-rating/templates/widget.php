...
?>
        ...
        <p>
			...
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('class_fill')); ?>" name="<?php echo esc_attr($this->get_field_name('class_fill')); ?>" value="1"<?php echo (($class_fill) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('class_fill')); ?>"><?php echo esc_attr(_e('Fill background', 'g-business-reviews-rating')); ?></label><br>
