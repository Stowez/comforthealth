...
<div class="featherlight featherlight-iframe mimic" style="display: block; background:rgba(0,0,0,0.8)"><div class="featherlight-content"><button class="featherlight-close-icon featherlight-close" aria-label="Close">✕</button><iframe src="http://www.youtube.com/embed/RbV9RcT0xOQ?rel=0&amp;controls=0&amp;showinfo=0&amp;autoplay=1" frameborder="0" allow="autoplay; encrypted-media" autplay allowfullscreen="true" style="display:block;border:none;height:80vh;width:80vw;" class="featherlight-inner"></iframe></div></div>
	<script>
